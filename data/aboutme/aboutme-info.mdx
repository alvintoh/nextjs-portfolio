...
Hello! I'm Alvin, a software development enthusiast with a knack for untangling complex problems and crafting efficient solutions. My arsenal includes Java, Python, Go and FrontEnd technologies, and I'm always on the lookout for new challenges to hone my skills.
...
**Tools used**: Java 17, Spring Boot, Hibernate, MyBatis, Liquibase, Flyway, Feign, MariaDB, PostgreSQL, Redis, ClickHouse, Kafka, Docker, TestContainer, JUnit, JMeter, PowerJob, XXL-JOB, FastAPI, Flask.
...
**Tools used**: Javascript, Typescript, Angular, Express.js, Mongoose, MongoDB, Docker, IBM Cloud.
